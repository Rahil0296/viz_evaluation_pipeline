...
# Title and labels
plt.title('Feature Correlation Heatmap with Emphasis on Energy Consumption (kWh)', fontsize=14)
...
# Show plot
plt.savefig('ev_charging_results/gpt5.2/run2_rich_context/ev_viz_rich_context_output.png', dpi=300, bbox_inches='tight')
plt.close()