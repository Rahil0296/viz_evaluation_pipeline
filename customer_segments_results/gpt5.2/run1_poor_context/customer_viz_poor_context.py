...
# Select numeric features (as generated by model — NOT modified)
...
plt.savefig('customer_segments_results/gpt5.2/run1_poor_context/customer_viz_poor_context_output.png', dpi=300, bbox_inches='tight')
plt.close()