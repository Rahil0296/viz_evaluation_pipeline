...
plt.title("Survival Rates by Passenger Class (Titanic)")

plt.savefig('titanic_results/gpt5.2/survival/run2_poor_context/survival_viz_poor_context_output.png', dpi=300, bbox_inches='tight')
plt.close()